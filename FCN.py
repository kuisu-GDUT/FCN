...
class FCNs(nn.Module):
    ...
    def forward(self, x):
        output = self.pretrained_net(x)
        x5 = output['x5']#[n, 512,5,5]
        x4 = output['x4']#[n,512,10,10]
        x3 = output['x3'] #[n,256,20,20]
        x2 = output['x2'] #[n,128,40,40]
        x1 = output['x1'] #[n,64,80,80]
        ...
        score = self.bn4(self.relu(self.deconv4(score)))  
        score = score + x1                                
        score = self.bn5(self.relu(self.deconv5(score))) #[n,32,160,160]
        score = self.classifier(score)      #[n,classes, 160, 160]
